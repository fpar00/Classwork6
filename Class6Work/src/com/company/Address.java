...
public class Address {
    ...
    public String createAddress (String country, String city, int postalCode, String streetName, int apartmentNumb){
        return String.format("You live in %s, %s, %s, %d, %d", streetName, city, country, postalCode, apartmentNumb);
    }
}
